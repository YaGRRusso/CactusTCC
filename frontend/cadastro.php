                ...
                <div class="col-sm-7">
                    <center>
                        ...
                        <form action="../backend/cadUser.php" method=post oninput='senha2.setCustomValidity(senha2.value != senha.value ? "As senhas não são iguais" : "")'>
                            ...
                            <h5>Nome</h5>
                            <input type="text" name="nome" class="form-control w-75" maxlength="60" placeholder="Digite aqui..."><br/>
                            <h5>Senha</h5>
                            <input type="password" name="senha" class="form-control w-75" maxlength="30" placeholder="Digite aqui..."><br/>
                            <h5>Repita a Senha</h5>
                            <input type="password" name="senha2" class="form-control w-75" maxlength="30" placeholder="Digite aqui..."><br/>
                            <h5>E-mail</h5>
