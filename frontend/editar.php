...
<html>
    ...
    <body>
        ...
        <div class="container my-5">
            <center>
                <h2 class="display-5">
                    Olá, edite ou exclua uma roupa!</br>
                </h2>
                <h5 class="display-5 px-5">
                    Adicione o id e altere os dados!
                </h5>
            </center>
        </div>
            ...
            ?>
                ...
                <div class="col-sm-10 p-5 m-2 border rounded" style="background-color: rgb(245, 245, 245);">
                    ...
                    <center>
                        ...
                        <form action="../../backend/atRou.php" enctype="multipart/form-data" method="POST">

                            <h5>Id:<br/></h5>
                            <?php echo"
                                <input type='text' name='id' value='$roupa[id_roupa]' required='required' class='form-control w-75' maxlength='60' readonly><br/><br/>
                            ";?>

                            <h5>Nome:<br/></h5>
                            <?php echo"
                                <input type='text' name='nome' value='$roupa[nm_roupa]' required='required' class='form-control w-75' maxlength='60'><br/><br/>
                            ";?>

                            <h5>Descrição:<br/></h5>
                            <?php echo"
                                <textarea name='descricao' required='required' rows='3' class='form-control w-75' maxlength='255'>$roupa[dc_roupa]</textarea><br/><br/>
                            ";?>

                            <h5>Valor:<br/></h5>
                            <?php echo"
                                <input type='number' name='valor' value='$roupa[vl_roupa]' required='required' step='0.01' class='form-control w-75'><br/><br/>
                            ";?>
                            ...
                            <h5>Imagem:<br/></h5>
                            <input type="file" class="form-control w-75" name="imagem[]" multiple>
                            <label class='radio form-control-inline w-50 float-left'><input type='radio' id='n' value='n' name='altIm' checked> Manter imagem original</label>
                            <label class='radio form-control-inline w-50 float-left'><input type='radio' id='s' value='s' name='altIm'> Alterar imagem original</label>
                            <h5><br/><br/><br/></h5>

                            <button type="submit" class="btn btn-outline-primary w-75">Editar</button><br/><br/><br/>
                        </form>
                        ...
                        <h3 class="display-5 px-5 text-center text-danger">
                            Exclua uma roupa.
                        </h3></br></br>

                        <form action="../../backend/exRou.php" enctype="multipart/form-data" method="POST">

                            <h5>Id:<br/></h5>
                            <?php echo"
                                <input type='text' name='id' value='$roupa[id_roupa]' required='required' class='form-control w-75' maxlength='60' readonly><br/><br/>
                            ";?>
                            <h5>Digite a senha de exclusão:<br/></h5>
                            <input type="text" name="senhaEx" required="required" class="form-control w-75" maxlength="60"><br/><br/>
                            <button type="submit" class="btn btn-outline-danger w-75">Excluir</button>
